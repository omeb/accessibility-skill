---
name: wix-a11y-react-patterns
description: Use when building interactive React components such as modals, dialogs, dropdown menus, tabs, accordions, data tables, comboboxes, autocomplete inputs, toast notifications, navigation menus, toggle switches, sortable/draggable lists, skip links, tooltips, or confirmation dialogs. Provides complete accessible implementation patterns with ARIA, keyboard handling, and focus management.
---
